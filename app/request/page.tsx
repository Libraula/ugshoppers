                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-xl border-2 border-orange-200">
                    ...
                    <ul className="text-xs sm:text-sm text-gray-600 space-y-2 sm:space-y-3">
                      ...
                      <li className="flex items-start">
                        <div className="w-2 h-2 bg-orange-500 rounded-full mt-1.5 mr-3 flex-shrink-0"></div>
                        <span>Pay easily using MTN Mobile Money or Airtel Money</span>
                      </li>
                      <li className="flex items-start">
                        <div className="w-2 h-2 bg-orange-500 rounded-full mt-1.5 mr-3 flex-shrink-0"></div>
                    ...
                    <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                      <div className="flex items-center justify-between mb-3">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">Payment Options:</p>
                      </div>
                      <div className="flex items-center gap-3 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-50 border border-yellow-200 rounded-lg px-3 py-2">
                          ...
                          />
                          <span className="text-xs font-medium text-gray-800">MTN MoMo</span>
                        </div>
                        <div className="flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
                          <img
                            ...
                            className="w-5 h-5 object-contain"
                          />
                          <span className="text-xs font-medium text-gray-800">Airtel Money</span>
                        </div>
                      </div>
