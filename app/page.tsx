          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              <div className="space-y-4">
                ...
                <p className="max-w-[800px] text-gray-600 text-lg md:text-xl leading-relaxed">
                  Discover real stories from UgShopper customers and see how we deliver happiness across Uganda.
                </p>
              </div>
            </div>
            ...
            <div className="relative max-w-6xl mx-auto">
              <Carousel className="w-full" opts={{ loop: true }} plugins={undefined}>
                <CarouselContent>
                  {[
                    {
                      id: 1,
                      ...
                      location: "Kampala",
                      testimonial:
                        "Amazing service! Got my iPhone 15 from Amazon delivered right to my doorstep. The whole process was smooth and transparent.",
                    ...
                    },
                    {
                      ...
                      location: "Mbale",
                      testimonial:
                        "UgShopper helped me get my business supplies from Alibaba. Professional service and great communication throughout!",
                    ...
                    },
                    {
                      ...
                      location: "Tororo",
                      testimonial:
                        "Ordered electronics from eBay and they arrived in perfect condition. The packaging was excellent and delivery was fast!",
                      item: "Gaming Setup",
                      rating: 5,
                    },
                    {
                      ...
                      location: "Busia",
                      testimonial:
                        "The team at UgShopper is incredible! They found exactly what I was looking for and delivered it safely to my home.",
                      item: "Fashion Items",
                      rating: 5,
                    },
                    {
                      ...
                      location: "Kapchorwa",
                      testimonial:
                        "Excellent customer service! They kept me updated throughout the entire process and the items arrived exactly as described.",
                    ...
                    },
                    {
                      id: 6,
                      image:
                        "https://img.freepik.com/free-photo/close-up-delivery-person-giving-parcel-client_23-2149095900.jpg",
                      name: "Peter Wanyama",
                      location: "Sironko",
                      testimonial:
                        "I've used UgShopper multiple times now. They're reliable, honest, and their prices are very fair. Highly recommended!",
                    ...
                    },
                    {
                      id: 7,
                      image:
                        "https://img.freepik.com/free-photo/close-up-delivery-person-giving-parcel-client_23-2149095913.jpg",
                      name: "Ruth Akello",
                      location: "Bukwo",
                      testimonial:
                        "Got my dream laptop from Amazon through UgShopper. The whole experience was seamless and professional!",
                      item: "MacBook Pro",
                      rating: 5,
                    },
                  ].map((testimonial) => (
                    <CarouselItem
                      ...
                      style={{ flex: '0 0 100%', maxWidth: '420px' }}
                    >
                       {/* Responsive width: 100% on mobile, 50% on sm, 33.33% on lg+; max-w for desktop balance */}
                       <div className="h-full mx-auto" style={{ maxWidth: '420px' }}>
                ...
                {/* Removed CarouselPrevious and CarouselNext for auto-scroll */}
              </Carousel>
              <div className="text-center mt-8">
                <Button
                  variant="outline"
                  size="lg"
                  className="bg-white border-2 border-orange-200 hover:bg-orange-50 text-orange-600 hover:text-orange-700 transition-all duration-300"
                  asChild
                >
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              <div className="space-y-4">
                ...
                <p className="max-w-[800px] text-gray-600 text-lg md:text-xl leading-relaxed">
                  Honest pricing, no surprises. You only pay for what you order—no hidden fees, ever.
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                      <div className="flex items-center gap-3">
                        <img
                          src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/mtn-mobile-logo-icon.png"
                          alt="MTN Mobile Money"
                          className="w-8 h-8 object-contain"
                        />
                        <div>
                          <p className="font-semibold text-gray-900 text-sm">MTN Mobile Money</p>
                          <p className="text-xs text-gray-600">Pay with MTN MoMo</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                      <div className="flex items-center gap-3">
                        <img
                          src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/airtel-logo-icon.png"
                          alt="Airtel Money"
                          className="w-8 h-8 object-contain"
                        />
                        <div>
                          <p className="font-semibold text-gray-900 text-sm">Airtel Money</p>
                          <p className="text-xs text-gray-600">Pay with Airtel Money</p>
                        </div>
                      </div>
                      <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                    </div>
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      <p className="text-xs text-blue-800 text-center font-medium">
                        💡 We accept both MTN and Airtel mobile money for your convenience
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/testimonials" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">
                    Testimonials
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <span className="text-gray-300 text-sm">Mobile Money Payments</span>
                </li>
              </ul>
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 bg-gray-700 rounded-lg px-3 py-2">
                    ...
                    />
                    <span className="text-xs text-gray-300">MTN</span>
                  </div>
                  <div className="flex items-center gap-2 bg-gray-700 rounded-lg px-3 py-2">
                    <img
                      src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/airtel-logo-icon.png"
                      ...
                      className="w-5 h-5 object-contain"
                    />
                    <span className="text-xs text-gray-300">Airtel</span>
                  </div>
                </div>
              </div>
            </div>
